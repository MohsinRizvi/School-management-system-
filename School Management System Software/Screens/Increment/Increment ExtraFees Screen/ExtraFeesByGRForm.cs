...
{
    public partial class ExtraFeesByGRForm : TemplateForm
    {
        public ExtraFeesByGRForm()
        {
            InitializeComponent();
        }
        ...
        private void AddIncrement()
        {
            ...
            db.SaveOrUpdateRecord("usp_Increment_ExtraFeesByGR", Getobj());
        ...
        private void ExtraFeesByGRForm_Load(object sender, EventArgs e)
        {
            if (IsSearched == true)
            {
