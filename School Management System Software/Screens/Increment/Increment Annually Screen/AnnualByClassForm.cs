...
{
    public partial class AnnualByClassForm : TemplateForm
    {
        public AnnualByClassForm()
        {
            InitializeComponent();
        }

        private void AnnualByClassForm_Load(object sender, EventArgs e)
        {
        ...
        private void AddIncrement()
        {
            ...
            db.SaveOrUpdateRecord("usp_Increment_AnnuallyByClass", Getobj());
