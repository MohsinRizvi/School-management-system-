...
{
    public partial class AnnualByGRForm : TemplateForm
    {
        public AnnualByGRForm()
        {
            InitializeComponent();
        }
        ...
        private void AddIncrement()
        {
            ...
            db.SaveOrUpdateRecord("usp_Increment_AnnuallyByGR", Getobj());
        ...
        private void AnnualByGRForm_Load(object sender, EventArgs e)
        {
            if (IsSearched == true)
            {
